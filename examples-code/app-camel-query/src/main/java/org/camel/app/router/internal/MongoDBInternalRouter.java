...
public class MongoDBInternalRouter extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("direct:mongodb-movie-insert")
                ...
                .to("mongodb:connectionBean?database=api-query&collection=movies&operation=insert");
        ...
        from("direct:mongodb-movie-findAll")
                ...
                .to("mongodb:connectionBean?database=api-query&collection=movies&operation=findAll");
